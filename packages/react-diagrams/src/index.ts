...
import { CardNodeFactory } from './entities/node/CardNodeFactory';
import { BasicPortFactory } from './entities/port/BasicPortFactory';
...
export * from './entities/node/CardType';
export * from './entities/node/NodeModel';
export * from './entities/node/NodeType';
...
export const createEngine = (
  ...
  engine.getNodeFactories().registerFactory(new CardNodeFactory());

  engine.getPortFactories().registerFactory(new BasicPortFactory());

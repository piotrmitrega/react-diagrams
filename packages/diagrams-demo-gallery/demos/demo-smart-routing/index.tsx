import createEngine, {
	...
	DefaultLabelModel, LinkModel, RightAngleLinkModel, PathFindingLinkModel
...
export class PathFindingPortModel extends DefaultPortModel {
...
export default () => {
	...
	const port1 = node1.addPort(new PathFindingPortModel(false, 'out-1', 'Out'));
	node1.setPosition(340, 350);

	const node2 = new DefaultNodeModel('Node B', 'rgb(255,255,0)');
	const port2 = node2.addPort(new PathFindingPortModel(false, 'out-1', 'Out'));
	node2.setPosition(240, 80);
	const node3 = new DefaultNodeModel('Node C', 'rgb(192,255,255)');
	const port3 = node3.addPort(new PathFindingPortModel(true, 'in-1', 'In'));
	node3.setPosition(540, 180);
	const node4 = new DefaultNodeModel('Node D', 'rgb(192,0,255)');
	const port4 = node4.addPort(new PathFindingPortModel(true, 'in-1', 'In'));

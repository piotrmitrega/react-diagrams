...
export interface BaseEntityEvent<T extends BaseEntity = BaseEntity>
  extends BaseEvent {
  entity: T;
}

export interface BaseEntityListener<T extends BaseEntity = BaseEntity>
...
export interface DeserializeEvent<T extends BaseEntity = BaseEntity> {
  ...
  registerModel<T extends BaseModel = BaseModel>(model: T);
...
export class BaseEntity<
  T extends BaseEntityGenerics = BaseEntityGenerics
> extends BaseObserver<T['LISTENER']> {
  ...
  fireEvent<L extends Partial<BaseEntityEvent> & object>(
    event: L,
    k: keyof T['LISTENER'],
    force?: boolean,
  ) {
